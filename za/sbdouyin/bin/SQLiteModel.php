...
class SQLiteModel{
	...
	public function __construct($dbFile, $table_name = null, $db_instance = null){
		...
		//if( !is_object(SQLiteModel::$_db) ) $this->_connect();
	}
    ...
    private function _getDb(){
        if( !is_object(@SQLiteModel::$_db[$this->db_instance]) ) $this->_connect();
        return SQLiteModel::$_db[$this->db_instance];
    }
	...
	private function _connect(){
		...
		SQLiteModel::$_db[$this->db_instance] = new PDO("sqlite:{$this->dbFile}");
	}
